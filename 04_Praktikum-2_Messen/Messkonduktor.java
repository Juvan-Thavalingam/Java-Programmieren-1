...
public class Messkonduktor {
  ...
  private Random zufallszahlenGenerator = new Random();
  ...
  public int[][] messungenDurchfuehren(int[][] messResultate) {
    for (int row = 0; row < messResultate.length; row++) {
      for (int col = 0; col < messResultate[row].length; col++){
        messResultate[row][col] = einzelneMessungDurchfuehren();
      }
    }
