...
public class Spiel 
{
    ...
    private void wechsleRaum(Befehl befehl) 
    {
        ...
        if(richtung.equals("north")) {
            naechsterRaum = aktuellerRaum.gibAusgang("nordausgang");
        }
        if(richtung.equals("east")) {
            naechsterRaum = aktuellerRaum.gibAusgang("ostausgang");
        }
        if(richtung.equals("south")) {
            naechsterRaum = aktuellerRaum.gibAusgang("suedausgang");
        }
        if(richtung.equals("west")) {
            naechsterRaum = aktuellerRaum.gibAusgang("westausgang");
        }
    ...
    private void raumInfoAusgeben(){
        ...
        if(aktuellerRaum.gibAusgang("nordausgang") != null) {
            System.out.print("north ");
        }
        if(aktuellerRaum.gibAusgang("ostausgang") != null) {
            System.out.print("east ");
        }
        if(aktuellerRaum.gibAusgang("suedausgang") != null) {
            System.out.print("south ");
        }
        if(aktuellerRaum.gibAusgang("westausgang") != null) {
